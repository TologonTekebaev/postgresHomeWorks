...
--1 select brand, model, price from cars order by  brand, model, cars;
--2 select count(id) as id, sum(id) from cars;
--3 select * from cars where brand like 'Hyundai';
--4 select * from cars where color like 'Red' or color like 'Blue';
--5 select * from cars where year_of_issue between 2000 and 2010;---
--6 select count(brand) from cars where brand like 'Chevrolet';
--7 elect round(avg(year_of_issue)) from cars;-----
